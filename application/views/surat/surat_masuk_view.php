                            ...
                            <tr>
                                ...
                                <?php if($this->session->userdata('jabatan') == 'Sekretaris'):?>
                                    <td>
                                        ...
                                        <a href="<?php if($mail->status != 'pending'):?> disabled <?php endif;?><?php echo base_url('index.php');?>/surat/accept_surat/<?php echo $mail->id_mail?>" class="btn btn-success btn-sm" <?php if($mail->status != 'pending'):?> disabled <?php endif;?>>
